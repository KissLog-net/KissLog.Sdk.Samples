using NLog;
using NLog_AspNet_MVC.ActionFilters;
using NLog_AspNet_MVC.Exceptions;
using NLog_AspNet_MVC.Models;
using System;
...
namespace NLog_AspNet_MVC.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                KissLogRequestLogsUrl = $"https://kisslog.net/RequestLogs/{applicationId}/nlog-aspnet-mvc",
